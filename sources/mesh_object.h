...
#ifndef BLENDEROBJECT_H_
#define BLENDEROBJECT_H_
...
public:
	...
	RGBColor getColor();
	static bool collide(MeshObject* object1, Position3D  object1Position, MeshObject* object2, Position3D  object2Position);
	static bool collide(MeshObject* object1, MeshObject* object2);
	static bool collide(std::vector<MeshObject*> * obstacles, MeshObject* robot, Position3D robotPosition);
